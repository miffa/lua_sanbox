...
externalproject_add(
    lua_struct
    GIT_REPOSITORY https://github.com/miffa/lua_struct_uparse.git
    GIT_TAG c512e2b4bc0aa7c2140c8fe680279d7671e49ab1
    UPDATE_COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_LIST_DIR}/FindLua.cmake <SOURCE_DIR>/cmake
    CMAKE_ARGS ${SANDBOX_CMAKE_ARGS}
    INSTALL_ARGS ${INST_ARGS}
)
...
externalproject_add(
    lua_hyperloglog
    GIT_REPOSITORY https://github.com/miffa/lua_hyperloglog_uparse.git
    GIT_TAG 75834b4342933e58841de666b52f3893d36b09cf
    CMAKE_ARGS ${SANDBOX_CMAKE_ARGS}
    INSTALL_ARGS ${INST_ARGS}
)
...
externalproject_add(
    lua_cuckoo_filter
    GIT_REPOSITORY https://github.com/miffa/lua_cuckoo_filter_uparse.git
    GIT_TAG d0554ea5d92d669c79079f43c8c9fd31e6f8da3f
    CMAKE_ARGS ${SANDBOX_CMAKE_ARGS}
    INSTALL_ARGS ${INST_ARGS}
)
